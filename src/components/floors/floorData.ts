// 下市集学校の実在の校舎図（構内図）に準拠した教室データ。
// 各フロアは「縦の棟（v: 左側に上から下へ）」＋「下の横棟（h: 左から右へ）」のL字。
// 5（屋外・他）は校舎外エリアをまとめたタブ。
...
export const FLOOR_ROOMS: Record<number, FloorLayout> = {
  ...
  // 4F: 構内図どおり。トンボ教室・給食リフトは使用しないため除外。
  4: {
    v: [
      { id: 'r4-01', label: '階段' },
      { id: 'r4-02', label: 'トイレ' },
      { id: 'r4-03', label: 'トイレ' },
      { id: 'r4-04', label: '3-2' },
      { id: 'r4-05', label: '3-1 暖房あり' },
    ],
    h: [
      { id: 'r4-06', label: '吹奏楽器室' },
      { id: 'r4-07', label: '音楽準備室' },
      { id: 'r4-08', label: '音楽室1 50人 男子寝室', red: true },
      { id: 'r4-09', label: '音楽室2' },
    ],
  },
  // 5: 屋外・その他エリア（校舎外）。備品はスプレッドシート追加後に取り込む。
  5: {
    v: [
      { id: 'r5-01', label: '屋上' },
      { id: 'r5-02', label: '中庭' },
